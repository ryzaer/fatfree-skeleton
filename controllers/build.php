...
class build {
    ...
    private function set_consts(){
        if(!$this->const){
            ...
            $this->const = true;
            // for spa & pwa content
            $appSpaName = isset($this->f3->APP['name'])  && $this->f3->APP['name'] ? $this->f3->APP['name'] : 'Vanila SPA Router';
            $appSpaMain = isset($this->f3->SPA['main'])  && $this->f3->SPA['main'] ? $this->f3->SPA['main'] : 'main';
